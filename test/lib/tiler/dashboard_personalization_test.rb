...
# Per-dashboard theme: 4 token accessors (page_bg, tile_bg, tile_header_bg,
# gutter_bg) stored in the settings JSON.
module Tiler
  class DashboardPersonalizationTest < ActiveSupport::TestCase
    ...
    test "theme keys round-trip alongside other settings (no overwrite)" do
